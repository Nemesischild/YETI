...
import COM.ExampleProject.Web.Responsiveness.Pages.MubalooApproachPage;
import COM.ExampleProject.Web.Responsiveness.Pages.MubalooHomePage;
...
//                    "Mubaloo Home Page:  Test " + (i + 1) + ": " + dimensions.get(i));
    ...
    @TestInformation(
            ...
            testName = "Site Accessibility Audit`",
            testDescription = "<TEST OBJECTIVE JIRA/ADAPTAVIST>" +
                    "As a ... " +
                    "I want ..." +
                    "So that ...",
    ...
    @Test
    public void RSP_ACC_001() throws IOException {


        EnhancedAssertion.hardAssertCondition(
                WebNavUtils.validateSiteLoadWithinMaxLimit(ExampleProjectWebRunner.driver, "https://www.google.com", 10),
                "URL: \"https://www.google.com\" - Expected load time less than 10s");
